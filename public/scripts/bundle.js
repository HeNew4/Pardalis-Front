(function () {
	...
	(function(module) {
	    ...
	    })(typeof window !== "undefined" ? window : commonjsGlobal, function(window1, noGlobal) {
	        var arr = [];
	...
	var mostrarAlerta = function(mensaje, botones) {
	    // Obtener elementos
	    var $alerta = $('#miAlerta');
	    var $contenido = $alerta.find('.alerta-contenido');
	    var $mensajeElemento = $contenido.find('.alerta-mensaje');
	    var $botonesElemento = $contenido.find('.alerta-botones');
	    // Configurar mensaje
	    $mensajeElemento.text(mensaje);
	    // Configurar botones
	    $botonesElemento.empty();
	    botones.forEach(function(boton) {
	        var $btn = $('<button>').text(boton.texto);
	        $btn.css('backgroundColor', boton.color || '#4CAF50');
	        $btn.on('click', boton.onClick);
	        $botonesElemento.append($btn);
	    });
	    // Mostrar alerta
	    $alerta.show();
	    // Agregar botón cerrar
	    var $btnCerrar = $('<button>').text('Cerrar');
	    $btnCerrar.css('backgroundColor', '#C81E1E');
	    $btnCerrar.on('click', function() {
	        $alerta.hide();
	    });
	    $botonesElemento.append($btnCerrar);
	};
	$('svg').on('click', '*', function(event) {
	    var clickedId = $(this).attr('name');
	    if (clickedId) {
	        /* mostrarAlerta(`Elemento ${clickedId} cliqueado`, [
	      {
	        texto: 'Reproducir Audio',
	        color: '#FFD400',
	        onClick: () => {
	          alert('Manco no hay audio 👻');
	        },
	      },
	    ]); */ switch(clickedId){
	            case 'Publicidad':
	                mostrarAlerta("".concat(data.Publicidad.ingles, " / ").concat(data.Publicidad.espannol), [
	                    {
	                        texto: 'Reproducir Audio',
	                        color: '#FFD400',
	                        onClick: function() {
	                ...
	                break;
	            case 'Lampara':
	                mostrarAlerta("".concat(data.Lampara.ingles, " / ").concat(data.Lampara.espannol), [
	                    {
	                        texto: 'Reproducir Audio',
	                        color: '#FFD400',
	                        onClick: function() {
	                ...
	                break;
	            case 'Vagon':
	                mostrarAlerta("".concat(data.Vagon.ingles, " / ").concat(data.Vagon.espannol), [
	                    {
	                        texto: 'Reproducir Audio',
	                        color: '#FFD400',
	                        onClick: function() {
	                ...
	                break;
	            case 'Puerta':
	                mostrarAlerta("".concat(data.Puerta.ingles, " / ").concat(data.Puerta.espannol), [
	                    {
	                        texto: 'Reproducir Audio',
	                        color: '#FFD400',
	                        onClick: function() {
	                ...
	                break;
	            case 'Ventana':
	                mostrarAlerta("".concat(data.Ventana.ingles, " / ").concat(data.Ventana.espannol), [
	                    {
	                        texto: 'Reproducir Audio',
	                        color: '#FFD400',
	                        onClick: function() {
	                ...
	                break;
	            case 'Elevador':
	                mostrarAlerta("".concat(data.Elevador.ingles, " / ").concat(data.Elevador.espannol), [
	                    {
	                        texto: 'Reproducir Audio',
	                        color: '#FFD400',
	                        onClick: function() {
	                ...
	                break;
	            case 'Reloj':
	                mostrarAlerta("".concat(data.Reloj.ingles, " / ").concat(data.Reloj.espannol), [
	                    {
	                        texto: 'Reproducir Audio',
	                        color: '#FFD400',
	                        onClick: function() {
