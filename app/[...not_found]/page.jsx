  ...
  return (
    <div className="h-svh error text-center grid place-content-center">
      ...
      <main className="grid place-content-center ">
        ...
        <Link href='/'>
          <motion.button className="focus:outline-none text-white bg-primary hover:bg-secundary focus:ring-4 focus:ring-secundary font-medium rounded-lg text-sm px-5 py-2.5 me-2 dark:focus:ring-primary m-3 w-9/12 mb-10" 
          whileTap={{
               scale: 1.1,
               rotate: 5
              }}>
