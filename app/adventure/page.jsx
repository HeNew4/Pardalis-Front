            ...
            <main className='grid place-content-center grid-cols-2 p-6 bg-background rounded-lg hover:bg-background dark:bg-background m-4 '>
                <div className='grid grid-cols-1'>
                    {data.map((mundo, index) => (
                        ...
                        <button  onClick={() => setSelectWorld({nombre: "Juego", imagen: "/img/extra/importante.jfif", descripcion: "¿Que paso master?"})} className='grid place-content-center focus:outline-none text:dark bg-primary hover:bg-secundary focus:ring-4 focus:ring-secundary font-medium rounded-lg text-sm px-5 py-2.5 me-2 dark:focus:ring-primary m-3 w-9/12 mb-10 border-dashed border-2 border-black'>
                            ¿Te crees bueno?
                        </button>
                </div>
